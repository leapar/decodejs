(function(/*``*/
    ...
    function _$af5399002(fdage) {
        ...
        var prepareEmbedParams = function(a) {
          ...
          , embed = function(a, b) {
            ...
            if (b.pagePreset) {
                    ...
                    var f = [d.style.width, d.style.height]
                      , g = function() {
                        if (FullScreen.active()) {
                            ...
                            if (d.style.resize = "both",
                            f[0] != d.style.width || f[1] != d.style.height) {
                                f[0] = d.style.width,
                                f[1] = d.style.height,
                                c.resize(d.clientWidth - 12, d.clientHeight - 6 - 16)
                            }
                        }
                ...
                c = new WebViewer(b.fullFrame ? window.innerWidth : b.width,b.fullFrame ? window.innerHeight : b.height,a),
                webview = c
            }
        ...
        Lights.prototype.update = function(a, b) {
            ...
            for (var f = new Float32Array(this.finalTransformBuffer), g = Matrix.empty(), h = Matrix.empty(), k = Matrix.empty(), l = Vect.empty(), m = Vect.empty(), n = Vect.empty(), r = Vect.empty(), e = Vect.empty(), p = [], q = [], u = Matrix.create(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), d = 0; d < this.count; ++d) {
                ...
                for (l = 0; 8 > l; ++l) {
                    ...
                    0 == l ? (p[0] = q[0] = e[0],
                    p[1] = q[1] = e[1],
                    p[2] = q[2] = e[2]) : (p[0] = Math.min(p[0], e[0]),
                ...
                ;var l = -p[2]
                  , m = -q[2]
                  , s = this.spot[3 * d];
                0 < s ? (l = Math.min(l, 1 / this.parameters[3 * d + 2]),
                m = Math.max(0.005 * l, m),
                Matrix.perspective(h, s, 1, m, l),
                d < this.shadowCount && (l = 2 * -Math.tan(0.00872664625 * s),
                ...
                this.shadowTexelPadProjections[4 * d + 3] = this.modelViewBuffer[16 * d + 14] * l)) : (Matrix.ortho(h, p[0], q[0], p[1], q[1], m, l),
        ...
        Material.prototype.bind = function(a) {
            ...
            ;var b = a.view, c = a.lights, d = a.sky, e = a.shadow, f = this.shader, g = this.skinParams, h = this.anisoParams, k = this.microfiberParams, l, m = this.gl, n = f.params, r = this.textures, p = f.samplers;
            f.bind();
            this.blend();
            ...
            if (0 < c.count && (m.uniform4fv(n.uLightPositions, c.positionBuffer),
            ...
            q = 0.392699 * a.postRender.sampleIndex,
            m.uniform2f(n.uShadowKernelRotation, 0.5 * Math.cos(q), 0.5 * Math.sin(q)),
            0 < c.shadowCount)) {
            ...
            ;g && (m.uniform3fv(n.uSubdermisColor, g.subdermisColor),
            m.uniform4fv(n.uTransColor, g.transColor),
            m.uniform4fv(n.uFresnelColor, g.fresnelColor),
            m.uniform1f(n.uFresnelOcc, g.fresnelOcc),
            m.uniform1f(n.uFresnelGlossMask, g.fresnelGlossMask),
            m.uniform1f(n.uFresnelIntegral, g.fresnelIntegral),
            m.uniform1f(n.uTransIntegral, g.transIntegral),
            m.uniform1f(n.uTransSky, g.transSky),
            m.uniform1f(n.uSkinShadowBlur, 8 * Math.min(g.shadowBlur, 1)),
            m.uniform1f(n.uNormalSmooth, g.normalSmooth),
            (l = this.extrasTexCoordRanges.subdermisTex) && m.uniform4fv(n.uTexRangeSubdermis, l),
            (l = this.extrasTexCoordRanges.translucencyTex) && m.uniform4fv(n.uTexRangeTranslucency, l),
            (l = this.extrasTexCoordRanges.fuzzTex) && m.uniform4fv(n.uTexRangeFuzz, l));
            k && (m.uniform4fv(n.uFresnelColor, k.fresnelColor),
            m.uniform1f(n.uFresnelOcc, k.fresnelOcc),
            m.uniform1f(n.uFresnelGlossMask, k.fresnelGlossMask),
            m.uniform1f(n.uFresnelIntegral, k.fresnelIntegral),
            (l = this.extrasTexCoordRanges.fuzzTex) && m.uniform4fv(n.uTexRangeFuzz, l));
            h && (m.uniform3fv(n.uAnisoTangent, h.tangent),
            m.uniform1f(n.uAnisoStrength, h.strength),
            m.uniform1f(n.uAnisoIntegral, h.integral),
            (l = this.extrasTexCoordRanges.anisoTex) && m.uniform4fv(n.uTexRangeAniso, l));
            if (l = this.extrasTexCoordRanges.emissiveTex) {
                m.uniform4fv(n.uTexRangeEmissive, l),
        ...
        MeshRenderable.prototype.draw = function(a) {
            ...
            if (this.material.bind(a)) {
                ...
                (this.material.cullBackFaces) ? (b.enable(b.CULL_FACE),
        ...
        MeshRenderable.prototype.drawOutline = function(a) {
            ...
            if (this.material.outlineShader.complete()) {
                ...
                var f = 28;
                this.mesh.secondaryTexCoord && (f += 8),
                a = s.attribs;
                b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, this.mesh.indexBuffer);
                b.bindBuffer(b.ARRAY_BUFFER, this.mesh.vertexBuffer);
                b.enableVertexAttribArray(a.vPosition);
        ...
        MeshRenderable.prototype.drawAlphaShadow = function(a, b) {
            var c = this.gl;
            (this.material.cullBackFaces) ? (c.enable(c.CULL_FACE),
        ...
        function PostRender(a, b, c) {
            ...
            this.sampleIndex = 0;
            c && (c = [],
            this.gl.hints.mobile ? (this.sampleCount = 3,
            this.sampleOffsets = [[-0.4375, -0.5625], [0.625, -0.25], [-0.1875, 0.5]]) : (c.push("#define HIGHQ"),
            this.sampleCount = 16,
            this.sampleOffsets = [[-1, 0], [-0.866, -0.5], [-0.7071, -0.7071], [-0.5, -0.866], [0, -1], [0.5, -0.866], [0.7071, -0.7071], [0.866, -0.5], [1, 0], [0.866, 0.5], [0.7071, 0.7071], [0.5, 0.866], [0, 1], [-0.5, 0.866], [-0.7071, 0.7071], [-0.866, 0.5]]),
                ...
                for (var k = Matrix.empty(), l = !1, m = 0; m < e; ++m) {
                    if (d.shadowsNeedUpdate[m]) {
                        ...
                        for (r = 0; r < a.meshRenderables.length; ++r) {
                            p = a.meshRenderables[r],
                            q = p.material,
                            p.mesh.desc.castShadows && q.castShadows && 0 < q.shadowAlphaTest && (q.textures.albedo.bind(n.samplers.tAlbedo),
                            p.drawAlphaShadow(n.attribs.vPosition, n.attribs.vTexCoord))
                        }
                    }
                }
                ;l && (b.bind(),
        ...
        Texture.prototype.setParams = function() {
            ...
            this.desc.clamp && (a.texParameteri(this.type, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE),
            a.texParameteri(this.type, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE));
        ...
        TextureCache.prototype.fromFilesMergeAlpha = function(a, b, c) {
            ...
            ;var f = this.gl;
            this.mergeShader || (this.mergeShader = new Shader(this.gl),
            this.mergeShader.build("precision highp float; varying vec2 c; attribute vec2 pos; void main(){ gl_Position.xy = 2.0*pos-vec2(1.0); gl_Position.zw = vec2(0.5,1.0); c=pos; }", "precision highp float; varying vec2 c; uniform sampler2D tRGB,tA; void main(){ gl_FragColor.xyz=texture2D(tRGB,c).xyz; gl_FragColor.w=texture2D(tA,c).x; }"),
        ...
        UI.prototype.showActiveView = function() {
            ...
            fdage.largeUI ? (this.menuCluster.style.width = "72px",
            ...
            .bind(this, home);
            b && (b = e(this.menuCluster.contents, "\u5168\u5c4f", "fullscreen", "fullscreen" + a + "x.png", d++, c),
            ...
            void (0) !== fdage.hostImage && (fdage.hostURL && (g = document.createElement("a"),
            g.href = fdage.hostURL,
            g.target = "_blank"),
            f = document.createElement("img"),
            f.src = fdage.hostImage,
            f.style.position = "absolute",
            f.style.top = "4px",
            f.style.left = "4px",
            f.style.opacity = 0.65,
            f.style["-webkit-transform"] = f.style.transform = "translate(-50%,-50%) scale(0.5,0.5) translate(50%,50%)",
            fdage.hostURL ? (f.onmouseover = function() {
            ...
            fdage.showFrameTime && (this.frameTimer = document.createElement("text"),
        ...
        UI.prototype.animate = function() {
            ...
            ;this.sceneStats && (a = !!this.sceneStats.parentElement,
            b = this.stripData && this.stripData.active(),
        ...
        View.prototype.loadView = function(a, b) {
            ...
            this.modelMatrix = a.modelMatrix || Matrix.identity(),
            this.radius = parseFloat(a.orbitRadius),
            this.fov = a.fov,
        ...
        WebViewer.prototype.initGL = function() {
            ...
            if (!this.gl) {
                return this.ui.showFailure("webgl\u51fa\u9519\u3002</br>\u5efa\u8bae\u60a8\u5c06\u6d4f\u89c8\u5668\u5347\u7ea7\u81f3\u6700\u65b0\u7248\u672c\uff0c\u4ee5\u83b7\u6700\u597d\u7684\u4f53\u9a8c\u3002<br><span style=\"font-size:0.8em\">\u83b7\u77e5\u66f4\u591awebgl\u6d4f\u89c8\u5668\u4fe1\u606f\u8bf7<a href=\"webglInfo.html\">\u70b9\u51fb\u6b64\u5904</a></span>", this),
                !1
            }
        ...
        WebViewer.prototype.updateLoad = function() {
            this.scene.complete() ? (this.ui.showActiveView(),
            this.requestFrame(this.update.bind(this))) : this.requestFrame(this.updateLoad.bind(this));
            this.ui.animate()
        }
        ;
